...
locals {
  ...
  kf_cluster_name = "" # Name of the Apache Kafka® cluster
  kf_password     = "" # User's password in Apache Kafka® cluster

  # Settings for the Compute Cloud VM
  ...
  kf_version  = "3.9"         # Desired version of Apache Kafka®. For available versions, see the documentation main page: https://yandex.cloud/en/docs/managed-kafka/.

  # Settings for the Virtual Private Cloud network infrastructure
...
resource "yandex_compute_instance" "vm-mirror-maker" {
  ...
  network_interface {
    ...
    nat       = true # Assigns public IP-address for connection from the Internet
  }
